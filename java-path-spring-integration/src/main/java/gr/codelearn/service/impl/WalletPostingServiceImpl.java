...
@Slf4j
@AllArgsConstructor
public class WalletPostingServiceImpl implements WalletPostingService {
    ...
    public Map<String, Object> makeTransaction(Map<String, Object> payload) {
        ...
        // 2) Add fee from debtor to Bank
        log.info("Adding fee from debtor to bank.");
